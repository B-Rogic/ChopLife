...
const SemiFooterComponent = ({className}) => {
  ...
  return (
    <div ref={rotationTriggerRef4} className={`relative ${className}`}>
        ...
        <div className="grid md:grid-cols-2 items-center backdrop-blur-lg w-full md:p-20 p-5">
            ...
            <div className="w-[90%] h-full overflow-hidden rounded-xl md:mx-0 mx-auto">
