  ...
  return (
    <>
      <div ref={container}  className="w-full md:h-screen h-[110vh] relative overflow-hidden">
        ...
        <Image src={shawarma} ref={rotationCardRef7} width={1000} height={1000} alt='leaf' className='absolute bottom-[-1020px] left-1/2 -translate-x-1/2 w-[130%] h-[110%] md:block hidden reloadmovedown9 scale-50' />
        <Image src={shawarma} ref={rotationCardRef8} width={1000} height={1000} alt='leaf' className='absolute bottom-[-1020px] left-1/2 -translate-x-1/2 min-w-[55rem] md:hidden block reloadmovedownmobile4' />
