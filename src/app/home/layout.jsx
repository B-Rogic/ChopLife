  ...
  return (
    <>
        <div className={`justify-between items-center w-full md:px-20 p-3 px-5 top-0 left-0 z-40 fixed bg-white text-[#1a1a1a] ${pathname === '/home/contact/portharcourt' ? 'hidden' : 'flex'}`}>
          ...
          <div ref={navRef} className={`flex items-center md:flex-row flex-col md:relative fixed md:top-0 left-0 top-[70px] gap-10 md:gap-20 w-full md:overflow-visible bg-white overflow-hidden transition-all duration-200 ease-in-out md:w-auto bg-red ${navActive ? 'h-full p-20' : 'h-0 p-0'}`} >
