            ...
            <div ref={containerRef} className="md:p-20 p-5 md:py-32 md:pt-32 pt-72 relative backdrop-blur-xl flex flex-col md:gap-10 gap-5">
                ...
                {activeFilter === 'fullmenu' ? (
                    <>
                        ...
                        {productItems.slice(8, 11).map((item) => (
                            <div key={item.id} className="md:p-5 bg-white w-full relative">
                                <div className="flex gap-8 flex-col md:items-start items-center md:flex-row">
                                    <div className="md:w-[25%] w-[105%] rounded-2xl overflow-hidden h-[35%] md:translate-y-0 translate-y-[-2%]">
                                        <Image src={item.image} alt='pepperoni pizza' width={1000} height={1000} className='w-full h-full' />
                                    </div>
                        ...
                        {productItems.slice(11, 12).map((item) => (
                            <div key={item.id} className="md:p-5 md:px-32 bg-white w-full relative">
                                <div className="flex gap-8 flex-col md:items-start items-center md:flex-row">
                        ...
                        {productItems.slice(12, 31).map((item) => (
                            <div key={item.id} className="md:p-5 md:px-32 bg-white w-full relative">
                                <div className="flex gap-8 flex-col md:items-start items-center md:flex-row">
                                    <div className="md:w-[35%] w-[105%] rounded-2xl overflow-hidden h-[22rem] md:translate-y-0 translate-y-[-2%]">
                        ...
                        {productItems.slice(31, -1).map((item) => (
                            <div key={item.id} className="md:p-5 md:px-32 bg-white w-full relative">
                                <div className="flex gap-8 flex-col md:items-start items-center md:flex-row">
                                    <div className="md:w-[35%] w-[105%] rounded-2xl overflow-hidden h-[22rem] md:translate-y-0 translate-y-[-2%]">
                                        <Image src={item.image} alt='fire cracker' width={1000} height={1000} className='w-full h-full object-cover' />
